...
<head>
  ...
  <meta name="description" content="CTransfer - Kullanım Koşulları">
  <meta name="keywords" content="kullanım koşulları, terms of service, şartlar">
  <meta name="author" content="CTransfer">
  <meta property="og:title" content="CTransfer - Kullanım Koşulları">
  <meta property="og:description" content="CTransfer kullanım koşulları ve hizmet şartları.">
  <meta property="og:image" content="cdn/logo.png">
  <meta property="og:url" content="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
  <link rel="icon" type="image/png" href="cdn/logo.png">
  <title>CTransfer - Kullanım Koşulları</title>
    ...
    <div class="max-w-4xl mx-auto px-4 py-12">
      ...
      <div class="text-center mb-12 relative">
        ...
        <div class="relative">
          ...
          <h1 class="text-4xl font-bold gradient-text brand-font mb-4">Kullanım Koşulları</h1>
          <p class="text-gray-500 dark:text-gray-400 text-lg">CTransfer'ı kullanırken uymanız gereken kurallar</p>
        </div>
      </div>
        ...
        <div class="p-8 space-y-8">
          ...
          <div class="space-y-4">
            ...
            <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
              CTransfer'ı kullanarak, aşağıdaki kullanım koşullarını kabul etmiş olursunuz. Lütfen bu koşulları dikkatlice okuyun.
            </p>
          </div>
          ...
          <div class="space-y-4">
            <h2 class="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400">
              <i class="fas fa-check-circle mr-2"></i> Kullanım Kuralları
            </h2>
            <div class="space-y-4">
              <div class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                <h3 class="font-semibold text-lg mb-2">Genel Kurallar</h3>
                <ul class="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-300">
                  <li>Uygulamayı yalnızca yasal amaçlar için kullanın</li>
                  <li>Telif hakkı olan içerikleri izinsiz paylaşmayın</li>
                  <li>Yerel ağ güvenliğini tehlikeye atmayın</li>
          ...
          <div class="space-y-4">
            <h2 class="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400">
              <i class="fas fa-upload mr-2"></i> Dosya Yükleme Kuralları
            </h2>
            <div class="space-y-4">
              <div class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                <h3 class="font-semibold text-lg mb-2">Dosya Kısıtlamaları</h3>
                <ul class="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-300">
                  <li>İzin verilen dosya türleri: Tüm dosya türleri</li>
                  <li>Virüs içeren dosyalar yüklenemez</li>
                  <li>Yasadışı içerik yüklenemez</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="space-y-4">
            <h2 class="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400">
              <i class="fas fa-exclamation-triangle mr-2"></i> Sorumluluk
            </h2>
            <div class="space-y-4">
              <div class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
                <h3 class="font-semibold text-lg mb-2">Kullanıcı Sorumluluğu</h3>
                <ul class="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-300">
                  <li>Yüklenen dosyaların içeriğinden kullanıcı sorumludur</li>
                  <li>Yerel ağ güvenliğinden kullanıcı sorumludur</li>
                  <li>Dosya paylaşımından doğabilecek sorunlardan kullanıcı sorumludur</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="space-y-4">
            <h2 class="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400">
              <i class="fas fa-sync-alt mr-2"></i> Değişiklikler
            </h2>
            <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
              Bu kullanım koşulları zaman zaman güncellenebilir. Değişikliklerden haberdar olmak için bu sayfayı düzenli olarak kontrol etmenizi öneririz.
            </p>
          </div>
        </div>
